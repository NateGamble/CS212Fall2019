...
namespace Mankalah
{
    ...
    public class KalahMatch {
        ...
        private static Player pTop = new neg6Player(Position.Top, timeLimit);	// TOP player (MAX)
        private static Player pBot = new buffyPlayer(Position.Bottom, timeLimit);	// BOTTOM player	
